Our team has created an obstacle avoiding robot, which takes inspiration from a RADAR for design. We used an ultrasonic sensor along with a servo motor as an axle.
